...
const REVIEWS = [
  ...
  { name: 'The Miller Farm', date: '2 months ago', title: 'Smooth interstate transport', body: 'We were worried about getting our calf from Victoria to QLD, but they arranged everything perfectly. Arrived completely unstressed.' },
